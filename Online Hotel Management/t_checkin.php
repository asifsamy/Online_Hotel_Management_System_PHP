<?php
   ...
   if (isset($_POST['btn_c'])) {
     $res2 = mysql_query("UPDATE reserve SET checked='1' WHERE re_id='$x'");
     if ($res2) {
      ...
      <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="t_checkin.php">Today's Check-in</a></li>
...
<?php
   ...
   $rs = mysql_query("SELECT rv.re_id, rm.type, rv.res_room, rn.c_in, rn.c_out, cs.firstName, cs.phone, rm.price, rn.stay FROM reserve rv, reservation rn, rooms rm, book bk, customer cs WHERE rv.re_id=rn.re_id and rv.room_no=rm.room_no and rv.re_id = bk.re_id and bk.cs_id=cs.cs_id and rv.checked='0' and rn.c_in='$t_date'");
      ...
      <tr>
                ...
                <td>
                  <form action="" method="post">
                    <button class="btn btn-default" name="btn_c" type="submit">CHECK IN</button>
                  </form>
                </td>           
              </tr>
