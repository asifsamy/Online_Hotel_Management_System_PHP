      ...
      <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
              <li class="active"><a href="t_book.php">Today's Payments</a></li>
...
<?php
   ...
   $rs = mysql_query("SELECT rv.re_id, rm.type, rv.res_room, rn.c_in, rn.c_out, cs.firstName, cs.phone, rm.price, rn.stay FROM reserve rv, reservation rn, rooms rm, book bk, customer cs WHERE rv.checked='2' and rn.c_out='$t_date' and rv.re_id=rn.re_id and rv.room_no=rm.room_no and rv.re_id = bk.re_id and bk.cs_id=cs.cs_id");
