      ...
      <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="ad_reservation.php">Reservations</a></li>
...
<?php
   ...
   $rs = mysql_query("SELECT rv.re_id, rm.type, rv.res_room, rn.c_in, rn.c_out, cs.firstName, cs.phone, rm.price, rn.stay FROM reserve rv, reservation rn, rooms rm, book bk, customer cs WHERE rv.re_id=rn.re_id and rv.room_no=rm.room_no and rv.re_id = bk.re_id and bk.cs_id=cs.cs_id and rn.c_in>='$t_date' and rv.checked='0'");
   
   if (mysql_num_rows($rs) < 1) { ?>
   	<div class="container">    
       <div class="row">
         <div class="col-sm-12">
           <h1 style="font-family: Courier New, Courier, monospace">Sorry! No Check Out for Today</h1>
