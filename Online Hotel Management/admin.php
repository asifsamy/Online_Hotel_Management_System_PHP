<?php
   ...
   if (isset($_POST['login'])) {
      ...
      $res2 = mysql_query("select * from admin where email = '$email' and password = '$password'");
      ...
      <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="myNavbar">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="active"><a href="admin.php"><span class="glyphicon glyphicon-user"></span> Admin Login</a></li>
