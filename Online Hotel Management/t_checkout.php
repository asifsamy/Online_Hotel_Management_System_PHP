<?php
   ...
   if (isset($_POST['btn_c'])) {
     $res2 = mysql_query("UPDATE reserve SET checked='2' WHERE re_id='$x'");
     if ($res2) {
       header("Location:t_checkin.php");
       exit;
     }
   }
      ...
      <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="t_checkout.php">Today's Check-out</a></li>
              <li><a href="#">Rstuarent</a></li>
              <li><a href="month.php">Monthly Income</a></li>
...
<?php
   ...
   $rs = mysql_query("SELECT rv.re_id, rm.type, rv.res_room, rn.c_in, rn.c_out, cs.firstName, cs.phone, rm.price, rn.stay FROM reserve rv, reservation rn, rooms rm, book bk, customer cs WHERE rv.re_id=rn.re_id and rv.room_no=rm.room_no and rv.re_id = bk.re_id and bk.cs_id=cs.cs_id and rv.checked='1' and rn.c_out='$t_date'");
   
   if (mysql_num_rows($rs) < 1) { ?>
    <div class="container">    
       <div class="row">
         <div class="col-sm-12">
           <h1 style="font-family: Courier New, Courier, monospace">Sorry! No Check In for Today</h1>
      ...
      <tr>
                ...
                <td>
                  <form action="" method="post">
                    <button class="btn btn-default" name="btn_c" type="submit">CHECK OUT</button>
                  </form>
                </td>
                <td>
                  <a href="pdf_bill.php?id=<?php echo $rowr[0]; ?>"> Bill</a>
                </td>
